...
const EditClassPerSubjectForm = ({cpsSubject, cpsClass, cpsFaculty, editShow, handleClose, handleEditCpsSave, setCpsSubject, setCpsFaculty,  setCpsClass}) => {
            ...
            <Modal show={editShow}
                ...
                <Modal.Body>
                  <Form.Group >
                    ...
                    <Form.Select value={cpsClass} onChange={(e)=>{
                      setCpsClassData(e.target.value);
                    }}>
                  ...
                  <Form.Group className='mt-3'>
                    ...
                    <Form.Select value={cpsFaculty} onChange={(e)=>{
                  ...
                  <Form.Group className='mt-3'>
                    ...
                    <Form.Select value={cpsSubject} onChange={(e)=>{
...
export default EditClassPerSubjectForm;
