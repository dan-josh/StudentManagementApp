...
const EditStudentForm = ({studentName, studentClass, studentId, editShow, handleClose, handleEditStudentSave, setStudentId, setStudentName,  setStudentClass}) => {
            ...
            <Modal show={editShow}
                ...
                <Modal.Body>
                  <Form.Group >
                    ...
                    <Form.Control value={studentId} onChange={(e)=>{
                  ...
                  <Form.Group className='mt-3'>
                    ...
                    <Form.Control value={studentName} onChange={(e)=>{
